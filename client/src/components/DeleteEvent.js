                    ...
                    <div class="container">
                        <form action='#'>
                            ...
                            <div className="row">
                                ...
                                <div class="col-75">
                                    <input className="input" disabled type="text" id="ename" name="eventName" placeholder="Code With Fun" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                <label disabled for="event">Type Of Event</label>
                                </div>
                                <div class="col-75">
                                <select className="input" disabled id="event" name="eventtype">
                            ...
                            <div class="row">
                                ...
                                <div class="col-75">
                                    <input className="input" disabled type="date" id="sdate" name="eventstartdate" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-25">
                                ...
                                <div class="col-75">
                                    <input className="input" disabled type="date" id="edate" name="eventenddate" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-75">
                                    <input className="input" disabled type="number" id="duration" name="duration" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                            <input className="input" disabled type="text" id="dname" name="departname" placeholder="KDPIT" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                                <CordinatorFields value="disabled" />
                            </div>
                        </div>
